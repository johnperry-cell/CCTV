...
namespace Illuminate\Database\Schema {
    ...
    class Blueprint {
         ...
         * @static 
         */
        public static function disabler()
        {
            return \Illuminate\Database\Schema\Blueprint::disabler();
        }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
         ...
         * @static 
         */
        public static function paginates($limit = 25, $page = null)
        {
            return \Illuminate\Database\Eloquent\Builder::paginates($limit, $page);
        }
